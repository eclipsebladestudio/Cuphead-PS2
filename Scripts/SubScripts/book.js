...
const intro = Sound.load("host:/Assets/Music/intro_book_music.wav");
Sound.repeat(true);
const introSlot = 5;
...
function getPageConfig(page) {
    const configs = {
        1: {
            images: Array.from({ length: 60 }, (_, i) => `Assets/Textures/StoryBook/Book/${i + 1}.png`),
...
without a care under the watchful eye of the wise Elder Kettle.`,
        ...
        2: {
            images: Array.from({ length: 22 }, (_, i) => `Assets/Textures/StoryBook/Page01-02/${i + 1}.png`),
...
of the tracks and entered the Devil's Casino.`,
        ...
        3: {
            images: Array.from({ length: 23 }, (_, i) => `Assets/Textures/StoryBook/Page02-03/${i + 1}.png`),
...
Dice, the casino's sleazy manager. "These fellas can't lose!"`,
        ...
        4: {
            images: Array.from({ length: 15 }, (_, i) => `Assets/Textures/StoryBook/Page03-04/${i + 1}.png`),
...
we raise the stakes?" he suggested with a toothy grin.`,
        ...
        5: {
            images: Array.from({ length: 23 }, (_, i) => `Assets/Textures/StoryBook/Page04-05/${i + 1}.png`),
            text: `"Win one more roll, and all the loot in my casino is yours!" the
Devil boomed. "But if you lose, I'll have your souls! Deal?"`,
        },
        6: {
            images: Array.from({ length: 22 }, (_, i) => `Assets/Textures/StoryBook/Page05-06/${i + 1}.png`),
...
he understood the danger. But it was too late!`,
        ...
        7: {
            images: Array.from({ length: 22 }, (_, i) => `Assets/Textures/StoryBook/Page06-07/${i + 1}.png`),
...
them. "Now, about those souls..."`,
        ...
        8: {
            images: Array.from({ length: 22 }, (_, i) => `Assets/Textures/StoryBook/Page07-08/${i + 1}.png`),
...
p-please, mister!" Cuphead added.`,
        ...
        9: {
            images: Array.from({ length: 15 }, (_, i) => `Assets/Textures/StoryBook/Page08-09/${i + 1}.png`),
...
their souls for me, and I just might pardon you two mugs."`,
        ...
        10: {
            images: Array.from({ length: 15 }, (_, i) => `Assets/Textures/StoryBook/Page09-10/${i + 1}.png`),
...
those souls! Otherwise I'll be the one collecting yours!"`,
        ...
        11: {
            images: Array.from({ length: 14 }, (_, i) => `Assets/Textures/StoryBook/Page10-11/${i + 1}.png`),
